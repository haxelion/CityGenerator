...
Buffers::Buffers(City *city)
{
    ...
    makeVertex(vertices, -1,-1,2,0,0);
    makeVertex(vertices+5, -1,1,2,0,0);
    makeVertex(vertices+10, 1,1,2,0,0);
    makeVertex(vertices+15, 1,-1,2,0,0);
    makeVertex(vertices+20, 1,-1,2,0,0);
    makeVertex(vertices+25, 1,1,2,0,0);
    makeVertex(vertices+30, -1,1,2,0,0);
    makeVertex(vertices+35, -1,-1,2,0,0);
    makeQuadIndices(indices, 0);
    makeQuadIndices(indices+6, 4);
