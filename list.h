...
template <class T> void List<T>::removeElementAt(int position)
{
    if(position == 0)
    {
...
template <class T> void List<T>::insertElementAt(T a, int position)
{
    if(position == 0)
    {
        addElement(a);
...
template <class T> T List<T>::getElementAt(int position)
{
    goTo(position);
    return current->getElement();
}

template <class T> T List<T>::getNextElement()
{
